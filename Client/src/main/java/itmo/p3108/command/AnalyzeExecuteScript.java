...
public class AnalyzeExecuteScript {
     ...
     */
    private static final String ADD_EXECUTE_SCRIPT_EXCEPTION1 = "Next line empty ,but it  must be argument for command below";
    ...
    public static void analyze(String[] commands, String fileName) {
        ...
        while (commadcounter < commands.length) {
            ...
            if (!Reflection.hasAnnotation(optional.get(), LineParameter.class)) {
                ...
                log.info(String.format("Analyze Command from %s-%s", fileName, commandName));
